 ...
 * under the License.
 */
package cas.validation;

import cas.CentralAuthenticationService;
import cas.authentication.Authentication;
 ...
 * @see CentralAuthenticationService#validateServiceTicket(String, Service)
 * @since 3.0.0
 */
